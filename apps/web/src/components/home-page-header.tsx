...
export const HomePageHeader = ({ tab }: { tab: ActiveTab }) => {
  ...
  return (
    <div className={`${scroll.y > 150 && scroll.y - scroll.lastY > 0 ? "invisible -translate-y-full" : "visible"} transition-all duration-200 sticky top-0 border-b border-(--app-border) bg-(--app-bg)/80 px-4 font-bold backdrop-blur-md`}>
